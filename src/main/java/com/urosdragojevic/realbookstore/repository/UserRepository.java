...
public class UserRepository {
    ...
    public User findUser(String username) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Search for user failed: " + username);
        }
    ...
    public boolean validCredentials(String username, String password) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.error("Validating credentials failed. More info : Username - " + username);
        }
        return false;
    }
    ...
    public void delete(int userId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            e.printStackTrace();
            LOG.warn("Failed to delete user. More info: ID - " + userId);
        }
